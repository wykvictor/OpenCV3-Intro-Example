...
int main( void )
{
	...
	// 【2.2】绘制矩形
  Rect rect1(Point(0, 7 * WINDOW_WIDTH / 8), Point(WINDOW_WIDTH/2, WINDOW_WIDTH));
  Rect rect2(Point(WINDOW_WIDTH / 4, 7 * WINDOW_WIDTH / 8), Point(WINDOW_WIDTH / 4 * 3, WINDOW_WIDTH));
