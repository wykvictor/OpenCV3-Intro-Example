### Cmake projects for book: [Introduction to OpenCV3 Programming](http://blog.csdn.net/poem_qianmo/article/details/44416709)

#### Compile the solution
* Install CMake:
	The latest version is OK. [download](https://cmake.org/) 

* Install OpenCV 3.1: [download](http://opencv.org/)
...
==============================
### Original README.md  from《OpenCV3编程入门》
